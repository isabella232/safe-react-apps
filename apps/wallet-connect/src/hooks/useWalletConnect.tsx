...
import WalletConnectV1 from '@walletconnect/client-v1';
...
type WalletConnectConnector = WalletConnect | WalletConnectV1;
...
const useWalletConnect = () => {
  ...
  const [wcClientData, setWcClientData] = useState<AppMetadata | undefined>();
  const [connector, setConnector] = useState<WalletConnect | WalletConnectV1 | undefined>();
  ...
  const wcConnect = useCallback(
    async (uri: string) => {
      ...
      if (version === '1') {
        const wcConnector = new WalletConnectV1({ uri });
